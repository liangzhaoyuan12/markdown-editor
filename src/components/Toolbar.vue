<template>
  <div class="toolbar" ref="toolbarRef">
    <div class="toolbar-group">
      <button @click="handleAction('undo')" :title="t('toolbar.undo') + ' (Ctrl+Z)'" class="toolbar-btn">
      ...
      <button @click="handleAction('redo')" :title="t('toolbar.redo') + ' (Ctrl+Y)'" class="toolbar-btn">
